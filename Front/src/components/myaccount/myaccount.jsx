        ...
        <div className="container">
            ...
            <div className="side">
                <nav className="sidemenu" aria-labelledby="account-menu">
                    ...
                    >
                        <svg className="ic" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                ...
                <div className="row">
                    <div className="col">
                        <article className="card-blw">
                            ...
                            <div className="fig1">
                                <p className="-fs16 -phs -pts">Ezra Ariwomoi</p>
                                <p className="-gy5 -pas -wb-ba">kropezra@gmail.com</p>
                            </div>
                        </article>
                    </div>
                    <div className="col">
                        <article className="card-blw">
                            <header className="hdr">
                                ...
                                <a className="btn _def _i _rnd -mhm" aria-label="Edit Address" href="/customer/address/edit/7952783/">
                                    <svg viewBox="0 0 24 24" className="ic" width="24" height="24">
                                        <use xlinkHref="https://www.jumia.co.ke/assets_he/images/i-icons.df665ea2.svg#edit"></use>
                                    </svg>
                                </a>
                            </header>
                            <div className="-pvs">
                                <p className="-fs16 -phm -pts">Your default shipping address:</p>
                                <address className="-gy5 -pvs -phm -n -tal">
                                    <p>Ezra Ariwomoi</p>
                                    <p>Not Applicable</p>
                                    <p>Kahawa Wendani/ Kenyatta University, Nairobi</p>
                                    <p className="-ltr">+254 715202539</p>
                                </address>
                            </div>
                        </article>
                    </div>
